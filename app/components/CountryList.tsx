...
export default function CountryList({ countries }: CountryListProps) {
    ...
    return (
        <article className="flex flex-col gap-8 items-center px-5 md:px-10 md:grid md:grid-cols-2 md:gap-10 md:items-start lg:px-0 lg:grid-cols-3 xl:grid-cols-4">
